  ...
  return (
    <div className="gallery-container">
      <div className="gallery-left-container">
        {property_images.map((propertyImage, i) => (
          <img
            onClick={() => setSelectedImage(propertyImage)}
            key={i}
            src={propertyImage}
          />
        ))}
      ...
      <div className="gallery-right-container">
        ...
        <div className="focus-image-conatiner">
          {selectedImage && <img src={selectedImage} alt="Selected-property" />}
        </div>
      </div>
    </div>
  );
